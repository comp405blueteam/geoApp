...
<div class="container">
   ...
   <div id="sidebar">
    ...
    <div id="header">
    	<div id="headerTitle">Edit Database</div>
    	<div id="headerLogin">
        ...
        <form name="contentForm" id="contentForm">
    	   <div id="contentLeftWindow">
    		  <div id="contentLeftWindowContents">
    			...
    			<select name="elementSelect" id="elementSelect">
    			 ...
    			 <button name="addButton" id="addButton">Add</button><br/><br/>
    			 ...
    			 <div id="itemContainer">
    				    <button name="confirmChangesButton" id="confirmChangesButton">Confirm Changes</button><br/><br/>
    	   ...
    	   <div id="contentRightWindow">
    		  <div id="contentRightWindowContents">
    			 <textarea disabled name="resultsTextarea" id="resultsTextarea" style="resize:none; overflow-y:auto; overflow-x:auto; width:100%; height:99%;";>LIST OF CHANGES AFTER DATABASE IS UPDATED</textarea>
    		  </div>
    	   </div>
        </form>
    </div>
